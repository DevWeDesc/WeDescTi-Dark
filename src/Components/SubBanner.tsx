  ...
  return (
    <div className="py-24 grid pl-20 grid-cols-2 bg-gradient-to-r from-[#100515] to-[#290738]">
      <div className="w-full h-full flex items-center justify-center">
        <p className="m-0 py-20 xxl:text-3xl xxl:max-w-[400px] text-2xl max-w-[350px] leading-relaxed font-mono">
      ...
      <div>
        <div className="w-[80%] xxl:w-[69%] h-[100%] bg-black border-[1px] border-[#0088FF]"></div>
      </div>
    </div>
  );
};
